...
def private():
    """private namespace"""
    from ..OBJECT import UGEObject, newUGEObject, Hierarchical, IntProp, CollectionProp
    ...
    class Object(UGEObject, Hierarchical):
        ...
        SubName = property(
            ...
            lambda Ob, Name = None: setattr( getData(Ob), 'Name', Ob.Name if Name is None else Name ) )
